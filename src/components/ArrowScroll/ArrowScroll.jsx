...
const ArrowScroll = ({
  tagName: Tag = 'div',
  className = 'absolute w-screen bottom-[20px] h-screen flex items-end justify-end lg:justify-center text-black mix-blend-difference pointer-events-none translate-y-100 right-[20px] lg:right-0',
  variant = 'default',
