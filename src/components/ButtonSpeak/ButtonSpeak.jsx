...
import styles from './ButtonSpeak.module.css';
...
const ButtonSpeak = (
  {
    ...
    motionVariants = {
        ...
        tap: { scale: 0.75, duration: 0.45,
          ease: [0.4, 0, 0.2, 1], },
        hover: { scale: 1.25, duration: 0.45,
          ease: [0.4, 0, 0.2, 1], },
        focus: { scale: 1.25, duration: 0.45,
          ease: [0.4, 0, 0.2, 1], }
    }
  },
  ref,
  ...
  return (
      <Tag
        className={`${styles.button_speak} ${
          styles[`button_speak__${variant}`]
