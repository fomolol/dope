...
import { Text, Loader, Stats, OrbitControls } from '@react-three/drei';
...
const TorusKnot = ({ rt }) => {
  ...
  const shaderMaterial = React.useRef(null);
...
const Content = ({
  ...
  const [rt, rtScene, rtCamera] = React.useMemo(() => {
